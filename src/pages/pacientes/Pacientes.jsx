    ...
    <div className="contenedor-pacientes">
      <div className="padre-pacientes">
        ...
        <div className="contenedor-opcionesPacientes">
          <ul>
            <li>
              <NavLink to="/pacientes/registro">Registro</NavLink>
            </li>
            <li>
              <NavLink to="/pacientes/verPacientes">Ver pacientes</NavLink>
            </li>
            <li>
              <NavLink to="/pacientes/diagnostico">Diagnostico</NavLink>
            </li>
            <li>
